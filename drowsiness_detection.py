...
# EAR value, below which it will be regared as a blink 
EAR_THRESHOLD = 0.3
...
# intialize the dlib's face detector model and the landmark predictor model
print("[INFO]Loading the predictor.....")
detector = dlib.get_frontal_face_detector() 
predictor = dlib.shape_predictor(args["shape_predictor"])

# Grab the indexes of the facial landamarks
